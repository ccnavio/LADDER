...
#-------------------------------------ADDED IMPORT FOR EPM/SERVO FUNCTION---------------####
...
MAV.doCommand(MAVLink.MAV_CMD.DO_SET_SERVO, 10, Script.GetParam('RC10_MAX'), 0, 0, 0, 0, 0)
Script.Sleep(5000)
Safety_Check()
MAV.doCommand(MAVLink.MAV_CMD.DO_SET_SERVO, 10, Script.GetParam('RC10_MIN'), 0, 0, 0, 0, 0)
Script.Sleep(5000)
Safety_Check()
